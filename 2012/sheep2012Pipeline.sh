#
# Script to create all of the 2012 Sheep tables
#
...
./pdfETHCSApipeline.sh 2012-Livestock.pdf pages.pdf table3-3.csv 48 49 tmpTable.csv 2012_Table_3-3.csv 2012
echo "TABLE 3-8: SHEEP AGED 2 YEARS AND OLDER BY SEX, PURPOSE, ZONE, AND REGION"
./pdfETHCSApipeline.sh 2012-Livestock.pdf pages.pdf table3-8.csv 58 59 tmpTable.csv 2012_Table_3-8.csv 2012
echo "TABLE 3-15 NUMBERS OF SHEEP BY SEX, BREED, ZONE, AND REGION"
./pdfETHCSApipeline.sh 2012-Livestock.pdf pages.pdf table3-15.csv 72 73 tmpTable.csv 2012_Table_3-15.csv 2012
...
./pdfETHCSApipeline.sh 2012-Livestock.pdf pages.pdf table3-19b.csv 88 89 tmpTable.csv 2012_Table_3-19b.csv 2012
...
./pdfETHCSApipeline.sh 2012-Livestock.pdf pages.pdf table3-20b.csv 104 105 tmpTable.csv 2012_Table_3-20b.csv 2012
echo "TABLE 3-23b: ESTIMATED NUMBER OF VACCINATED LIVESTOCK BY ZONE AND REGION - Sheep"
./pdfETHCSApipeline.sh 2012-Livestock.pdf pages.pdf table3-23b.csv 128 129 tmpTable.csv 2012_Table_3-23b.csv 2012
...
./pdfETHCSApipeline.sh 2012-Livestock.pdf pages.pdf table3-27b.csv 144 145 tmpTable.csv 2012_Table_3-27b.csv 2012
echo "2012 Sheep tables complete"
