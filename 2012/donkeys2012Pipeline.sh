#
# Script to create all of the 2012 Donkeys tables
#
...
# ./pdfETHCSApipeline.sh 2012-Livestock.pdf pages.pdf table3-5.csv 52 53 tmpTable.csv 2012_Table_3-5.csv 2012
echo "TABLE 3-11: DONKEYS AGED 3 YEARS AND OLDER BY SEX, PURPOSE, ZONE, AND REGION"
./pdfETHCSApipeline.sh 2012-Livestock.pdf pages.pdf table3-11.csv 64 65 tmpTable.csv 2012_Table_3-11.csv 2012
...
./pdfETHCSApipeline.sh 2012-Livestock.pdf pages.pdf table3-19e.csv 94 95 tmpTable.csv 2012_Table_3-19e.csv 2012
...
./pdfETHCSApipeline.sh 2012-Livestock.pdf pages.pdf table3-20e.csv 110 111 tmpTable.csv 2012_Table_3-20e.csv 2012
...
# ./pdfETHCSApipeline.sh 2012-Livestock.pdf pages.pdf table3-27d.csv 148 149 tmpTable.csv 2012_Table_3-27d.csv 2012
echo "2012 Donkeys tables complete"
