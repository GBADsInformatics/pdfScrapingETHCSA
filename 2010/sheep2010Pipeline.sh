#
# Script to create all of the 2010 Sheep tables
#
...
./pdfETHCSApipeline.sh 2010-Livestock.pdf pages.pdf table3-3.csv 44 45 tmpTable.csv 2010_Table_3-3.csv 2010
echo "TABLE 3-8: SHEEP AGED 2 YEARS AND OLDER BY SEX, PURPOSE, ZONE, AND REGION"
./pdfETHCSApipeline.sh 2010-Livestock.pdf pages.pdf table3-8.csv 54 55 tmpTable.csv 2010_Table_3-8.csv 2010
echo "TABLE 3-15 NUMBERS OF SHEEP BY SEX, BREED, ZONE, AND REGION"
./pdfETHCSApipeline.sh 2010-Livestock.pdf pages.pdf table3-15.csv 68 69 tmpTable.csv 2010_Table_3-15.csv 2010
...
./pdfETHCSApipeline.sh 2010-Livestock.pdf pages.pdf table3-19b.csv 84 85 tmpTable.csv 2010_Table_3-19b.csv 2010
...
./pdfETHCSApipeline.sh 2010-Livestock.pdf pages.pdf table3-20b.csv 100 101 tmpTable.csv 2010_Table_3-20b.csv 2010
echo "TABLE 3-23b: ESTIMATED NUMBER OF VACCINATED LIVESTOCK BY ZONE AND REGION - Sheep"
./pdfETHCSApipeline.sh 2010-Livestock.pdf pages.pdf table3-23b.csv 124 125 tmpTable.csv 2010_Table_3-23b.csv 2010
...
./pdfETHCSApipeline.sh 2010-Livestock.pdf pages.pdf table3-27b.csv 140 141 tmpTable.csv 2010_Table_3-27b.csv 2010
echo "2010 Sheep tables complete"
