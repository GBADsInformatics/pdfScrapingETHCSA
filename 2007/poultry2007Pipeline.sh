#
# Script to create all of the 2007 Poultry tables
#
...
./pdfETHCSApipeline.sh 2007-Livestock.pdf pages.pdf table3-17a.csv 71 72 tmpTable.csv 2007_Table_3-17a.csv 2007
echo "TABLE 3-17b: POULTRY INVENTORY BY TYPE, ZONE, AND REGION - Indigenous Breeds"
./pdfETHCSApipeline.sh 2007-Livestock.pdf pages.pdf table3-17b.csv 73 74 tmpTable.csv 2007_Table_3-17b.csv 2007
echo "TABLE 3-17c: POULTRY INVENTORY BY TYPE, ZONE, AND REGION - Hybrid"
./pdfETHCSApipeline.sh 2007-Livestock.pdf pages.pdf table3-17c.csv 75 76 tmpTable.csv 2007_Table_3-17c.csv 2007
echo "TABLE 3-17d: POULTRY INVENTORY BY TYPE, ZONE, AND REGION - Exotic Breeds"
./pdfETHCSApipeline.sh 2007-Livestock.pdf pages.pdf table3-17d.csv 77 78 tmpTable.csv 2007_Table_3-17d.csv 2007
...
./pdfETHCSApipeline.sh 2007-Livestock.pdf pages.pdf table3-19h.csv 95 96 tmpTable.csv 2007_Table_3-19h.csv 2007
...
./pdfETHCSApipeline.sh 2007-Livestock.pdf pages.pdf table3-20h.csv 111 112 tmpTable.csv 2007_Table_3-20h.csv 2007
echo "TABLE 3–22a: TOTAL EGG PRODUCTION BY ZONE, AND REGION - Indigenous Breeds"
./pdfETHCSApipeline.sh 2007-Livestock.pdf pages.pdf table3-22a.csv 115 116 tmpTable.csv 2007_Table_3-22a.csv 2007
echo "TABLE 3–22b: TOTAL EGG PRODUCTION BY ZONE, AND REGION - Hybrid"
./pdfETHCSApipeline.sh 2007-Livestock.pdf pages.pdf table3-22b.csv 117 118 tmpTable.csv 2007_Table_3-22b.csv 2007
echo "TABLE 3–22c: TOTAL EGG PRODUCTION BY ZONE, AND REGION - Exotic Breeds"
./pdfETHCSApipeline.sh 2007-Livestock.pdf pages.pdf table3-22c.csv 119 120 tmpTable.csv 2007_Table_3-22c.csv 2007
...
./pdfETHCSApipeline.sh 2007-Livestock.pdf pages.pdf table3-27f.csv 147 148 tmpTable.csv 2007_Table_3-27f.csv 2007
echo "2007 Poultry tables complete"
