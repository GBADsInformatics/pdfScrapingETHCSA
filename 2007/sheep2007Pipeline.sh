#
# Script to create all of the 2007 Sheep tables
#
...
./pdfETHCSApipeline.sh 2007-Livestock.pdf pages.pdf table3-3.csv 43 44 tmpTable.csv 2007_Table_3-3.csv 2007
echo "TABLE 3-8: SHEEP AGED 2 YEARS AND OLDER BY SEX, PURPOSE, ZONE, AND REGION"
./pdfETHCSApipeline.sh 2007-Livestock.pdf pages.pdf table3-8.csv 53 54 tmpTable.csv 2007_Table_3-8.csv 2007
echo "TABLE 3-15 NUMBERS OF SHEEP BY SEX, BREED, ZONE, AND REGION"
./pdfETHCSApipeline.sh 2007-Livestock.pdf pages.pdf table3-15.csv 67 68 tmpTable.csv 2007_Table_3-15.csv 2007
...
./pdfETHCSApipeline.sh 2007-Livestock.pdf pages.pdf table3-19b.csv 83 84 tmpTable.csv 2007_Table_3-19b.csv 2007
...
./pdfETHCSApipeline.sh 2007-Livestock.pdf pages.pdf table3-20b.csv 99 100 tmpTable.csv 2007_Table_3-20b.csv 2007
echo "TABLE 3-23b: ESTIMATED NUMBER OF VACCINATED LIVESTOCK BY ZONE AND REGION - Sheep"
./pdfETHCSApipeline.sh 2007-Livestock.pdf pages.pdf table3-23b.csv 123 124 tmpTable.csv 2007_Table_3-23b.csv 2007
...
./pdfETHCSApipeline.sh 2007-Livestock.pdf pages.pdf table3-27b.csv 139 140 tmpTable.csv 2007_Table_3-27b.csv 2007
echo "2007 Sheep tables complete"
