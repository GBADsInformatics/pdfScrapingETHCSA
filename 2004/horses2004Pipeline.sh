#
# Script to create all of the 2004 Horses tables
#
...
./pdfETHCSApipeline.sh 2004-Livestock.pdf pages.pdf table3-10.csv 55 56 tmpTable.csv 2004_Table_3-10.csv 2004
