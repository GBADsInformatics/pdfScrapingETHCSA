#
# Script to create all of the 2004 Cattle tables
#
...
#    TABLE 3-26a: NUMBER OF HOLDINGS BY SIZE OF CATTLE
#
...
./pdfETHCSApipeline.sh 2004-Livestock.pdf pages.pdf table3-2.csv 39 40 tmpTable.csv 2004_Table_3-2.csv 2004
...
echo "TABLE 3-26a: NUMBER OF HOLDINGS BY SIZE OF CATTLE"
./pdfETHCSApipeline.sh 2004-Livestock.pdf pages.pdf table3-26a.csv 97 98 tmpTable.csv 2004_Table_3-26a.csv 2004
echo "2004 Cattle tables complete"
