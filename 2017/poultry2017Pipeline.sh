#
# Script to create all of the 2017 Poultry tables
#
...
./pdfETHCSApipeline.sh 2017-Livestock.pdf pages.pdf table3-17b.csv 52 52 tmpTable.csv 2017_Table_3-17b.csv 2017
echo "TABLE 3-17c: POULTRY INVENTORY BY TYPE, ZONE, AND REGION - Hybrid"
./pdfETHCSApipeline.sh 2017-Livestock.pdf pages.pdf table3-17c.csv 53 53 tmpTable.csv 2017_Table_3-17c.csv 2017
echo "TABLE 3-17d: POULTRY INVENTORY BY TYPE, ZONE, AND REGION - Exotic Breeds"
./pdfETHCSApipeline.sh 2017-Livestock.pdf pages.pdf table3-17d.csv 53 53 tmpTable.csv 2017_Table_3-17d.csv 2017
...
./pdfETHCSApipeline.sh 2017-Livestock.pdf pages.pdf table3-19h.csv 58 58 tmpTable.csv 2017_Table_3-19h.csv 2017
...
./pdfETHCSApipeline.sh 2017-Livestock.pdf pages.pdf table3-20h.csv 62 62 tmpTable.csv 2017_Table_3-20h.csv 2017
echo "TABLE 3–22a: TOTAL EGG PRODUCTION BY ZONE, AND REGION - Indigenous Breeds"
./pdfETHCSApipeline.sh 2017-Livestock.pdf pages.pdf table3-22a.csv 63 63 tmpTable.csv 2017_Table_3-22a.csv 2017
