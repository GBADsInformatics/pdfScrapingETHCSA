#
# Script to create all of the 2017 Donkeys tables
#
...
# ./pdfETHCSApipeline.sh 2017-Livestock.pdf pages.pdf table3-5.csv 46 46 tmpTable.csv 2017_Table_3-5.csv 2017
echo "TABLE 3-11: DONKEYS AGED 3 YEARS AND OLDER BY SEX, PURPOSE, ZONE, AND REGION"
./pdfETHCSApipeline.sh 2017-Livestock.pdf pages.pdf table3-11.csv 49 49 tmpTable.csv 2017_Table_3-11.csv 2017
...
./pdfETHCSApipeline.sh 2017-Livestock.pdf pages.pdf table3-19e.csv 56 56 tmpTable.csv 2017_Table_3-19e.csv 2017
...
./pdfETHCSApipeline.sh 2017-Livestock.pdf pages.pdf table3-20e.csv 60 60 tmpTable.csv 2017_Table_3-20e.csv 2017
...
# ./pdfETHCSApipeline.sh 2017-Livestock.pdf pages.pdf table3-27d.csv 70 70 tmpTable.csv 2017_Table_3-27d.csv 2017
echo "2017 Horses tables complete"
