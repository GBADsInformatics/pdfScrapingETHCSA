#
# Script to create all of the 2013 Poultry tables
#
...
./pdfETHCSApipeline.sh 2013-Livestock.pdf pages.pdf table3-17a.csv 76 77 tmpTable.csv 2013_Table_3-17a.csv 2013
echo "TABLE 3-17b: POULTRY INVENTORY BY TYPE, ZONE, AND REGION - Indigenous Breeds"
./pdfETHCSApipeline.sh 2013-Livestock.pdf pages.pdf table3-17b.csv 78 79 tmpTable.csv 2013_Table_3-17b.csv 2013
echo "TABLE 3-17c: POULTRY INVENTORY BY TYPE, ZONE, AND REGION - Hybrid"
./pdfETHCSApipeline.sh 2013-Livestock.pdf pages.pdf table3-17c.csv 80 81 tmpTable.csv 2013_Table_3-17c.csv 2013
echo "TABLE 3-17d: POULTRY INVENTORY BY TYPE, ZONE, AND REGION - Exotic Breeds"
./pdfETHCSApipeline.sh 2013-Livestock.pdf pages.pdf table3-17d.csv 82 83 tmpTable.csv 2013_Table_3-17d.csv 2013
...
./pdfETHCSApipeline.sh 2013-Livestock.pdf pages.pdf table3-19h.csv 100 101 tmpTable.csv 2013_Table_3-19h.csv 2013
...
./pdfETHCSApipeline.sh 2013-Livestock.pdf pages.pdf table3-20h.csv 116 117 tmpTable.csv 2013_Table_3-20h.csv 2013
echo "TABLE 3–22a: TOTAL EGG PRODUCTION BY ZONE, AND REGION - Indigenous Breeds"
./pdfETHCSApipeline.sh 2013-Livestock.pdf pages.pdf table3-22a.csv 120 121 tmpTable.csv 2013_Table_3-22a.csv 2013
echo "TABLE 3–22b: TOTAL EGG PRODUCTION BY ZONE, AND REGION - Hybrid"
./pdfETHCSApipeline.sh 2013-Livestock.pdf pages.pdf table3-22b.csv 122 123 tmpTable.csv 2013_Table_3-22b.csv 2013
echo "TABLE 3–22c: TOTAL EGG PRODUCTION BY ZONE, AND REGION - Exotic Breeds"
./pdfETHCSApipeline.sh 2013-Livestock.pdf pages.pdf table3-22c.csv 124 125 tmpTable.csv 2013_Table_3-22c.csv 2013
...
./pdfETHCSApipeline.sh 2013-Livestock.pdf pages.pdf table3-27f.csv 152 153 tmpTable.csv 2013_Table_3-27f.csv 2013
echo "2013 Poultry tables complete"
