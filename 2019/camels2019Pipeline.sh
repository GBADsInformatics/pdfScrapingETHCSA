#
# Script to create all of the 2019 Camels tables
#
...
./pdfETHCSApipeline.sh 2019-Livestock.pdf pages.pdf table3-6.csv 54 55 tmpTable.csv 2019_Table_3-6.csv 2019
echo "TABLE 3-13: CAMELS AGED 4 YEARS AND OLDER BY SEX, PURPOSE, ZONE, AND REGION"
./pdfETHCSApipeline.sh 2019-Livestock.pdf pages.pdf table3-13.csv 68 69 tmpTable.csv 2019_Table_3-13.csv 2019
...
./pdfETHCSApipeline.sh 2019-Livestock.pdf pages.pdf table3-19g.csv 98 99 tmpTable.csv 2019_Table_3-19g.csv 2019
...
./pdfETHCSApipeline.sh 2019-Livestock.pdf pages.pdf table3-20g.csv 114 115 tmpTable.csv 2019_Table_3-20g.csv 2019
...
./pdfETHCSApipeline.sh 2019-Livestock.pdf pages.pdf table3-23d.csv 132 133 tmpTable.csv 2019_Table_3-23d.csv 2019
...
./pdfETHCSApipeline.sh 2019-Livestock.pdf pages.pdf table3-27e.csv 150 151 tmpTable.csv 2019_Table_3-27e.csv 2019
echo "2019 Camels tables complete"
