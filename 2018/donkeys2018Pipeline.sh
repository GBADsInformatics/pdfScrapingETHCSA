#
# Script to create all of the 2018 Donkeys tables
#
...
# ./pdfETHCSApipeline.sh 2018-Livestock.pdf pages.pdf table3-5.csv 45 45 tmpTable.csv 2018_Table_3-5.csv 2018
echo "TABLE 3-11: DONKEYS AGED 3 YEARS AND OLDER BY SEX, PURPOSE, ZONE, AND REGION"
./pdfETHCSApipeline.sh 2018-Livestock.pdf pages.pdf table3-11.csv 48 48 tmpTable.csv 2018_Table_3-11.csv 2018
...
./pdfETHCSApipeline.sh 2018-Livestock.pdf pages.pdf table3-19e.csv 55 55 tmpTable.csv 2018_Table_3-19e.csv 2018
...
./pdfETHCSApipeline.sh 2018-Livestock.pdf pages.pdf table3-20e.csv 59 59 tmpTable.csv 2018_Table_3-20e.csv 2018
...
# ./pdfETHCSApipeline.sh 2018-Livestock.pdf pages.pdf table3-27d.csv 69 69 tmpTable.csv 2018_Table_3-27d.csv 2018
echo "2018 Horses tables complete"
