...
#
#   File is edited to only give the output for the second table when 2 tables are in one page
#
# Libraries
import os
import sys
...
def main ( argv ):
    ...
    while myline:   
        ...
        if len(myline) != 0 and tableNo == 2 and not in_string.isdigit() and myline[0] != ",":
