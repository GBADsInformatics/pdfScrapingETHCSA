#
# Script to create all of the 2018 Mules tables
#
...
# ./pdfETHCSApipeline.sh 2018-Livestock.pdf pages.pdf table3-6.csv 45 45 tmpTable.csv 2018_Table_3-6.csv 2018
echo "TABLE 3-12: Mules AGED 3 YEARS AND OLDER BY SEX, PURPOSE, ZONE, AND REGION"
./pdfETHCSApipeline.sh 2018-Livestock.pdf pages.pdf table3-12.csv 48 48 tmpTable.csv 2018_Table_3-12.csv 2018
...
./pdfETHCSApipeline.sh 2018-Livestock.pdf pages.pdf table3-19f.csv 56 56 tmpTable.csv 2018_Table_3-19f.csv 2018
...
./pdfETHCSApipeline.sh 2018-Livestock.pdf pages.pdf table3-20f.csv 60 60 tmpTable.csv 2018_Table_3-20f.csv 2018
...
# ./pdfETHCSApipeline.sh 2018-Livestock.pdf pages.pdf table3-27e.csv 70 70 tmpTable.csv 2018_Table_3-27e.csv 2018
echo "2018 Mules tables complete"
