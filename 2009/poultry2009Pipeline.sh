#
# Script to create all of the 2009 Poultry tables
#
...
./pdfETHCSApipeline.sh 2009-Livestock.pdf pages.pdf table3-17a.csv 48 48 tmpTable.csv 2009_Table_3-17a.csv 2009
echo "TABLE 3-17b: POULTRY INVENTORY BY TYPE, ZONE, AND REGION - Indigenous Breeds"
./pdfETHCSApipeline.sh 2009-Livestock.pdf pages.pdf table3-17b.csv 48 48 tmpTable.csv 2009_Table_3-17b.csv 2009
echo "TABLE 3-17c: POULTRY INVENTORY BY TYPE, ZONE, AND REGION - Hybrid"
./pdfETHCSApipeline.sh 2009-Livestock.pdf pages.pdf table3-17c.csv 49 49 tmpTable.csv 2009_Table_3-17c.csv 2009
echo "TABLE 3-17d: POULTRY INVENTORY BY TYPE, ZONE, AND REGION - Exotic Breeds"
./pdfETHCSApipeline.sh 2009-Livestock.pdf pages.pdf table3-17d.csv 49 49 tmpTable.csv 2009_Table_3-17d.csv 2009
...
./pdfETHCSApipeline.sh 2009-Livestock.pdf pages.pdf table3-19h.csv 54 54 tmpTable.csv 2009_Table_3-19h.csv 2009
...
./pdfETHCSApipeline.sh 2009-Livestock.pdf pages.pdf table3-20h.csv 58 58 tmpTable.csv 2009_Table_3-20h.csv 2009
echo "TABLE 3–22a: TOTAL EGG PRODUCTION BY ZONE, AND REGION - Indigenous Breeds"
./pdfETHCSApipeline.sh 2009-Livestock.pdf pages.pdf table3-22a.csv 59 59 tmpTable.csv 2009_Table_3-22a.csv 2009
echo "TABLE 3–22b: TOTAL EGG PRODUCTION BY ZONE, AND REGION - Hybrid"
./pdfETHCSApipeline.sh 2009-Livestock.pdf pages.pdf table3-22b.csv 59 59 tmpTable.csv 2009_Table_3-22b.csv 2009
echo "TABLE 3–22c: TOTAL EGG PRODUCTION BY ZONE, AND REGION - Exotic Breeds"
./pdfETHCSApipeline.sh 2009-Livestock.pdf pages.pdf table3-22c.csv 60 60 tmpTable.csv 2009_Table_3-22c.csv 2009
...
./pdfETHCSApipeline.sh 2009-Livestock.pdf pages.pdf table3-27f.csv 67 67 tmpTable.csv 2009_Table_3-27f.csv 2009
echo "2009 Poultry tables complete"
