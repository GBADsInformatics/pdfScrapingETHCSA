#
# Script to create all of the 2008 Horses tables
#
...
./pdfETHCSApipeline.sh 2008-Livestock.pdf pages.pdf table3-5.csv 47 48 tmpTable.csv 2008_Table_3-5.csv 2008
echo "TABLE 3-10: HORSES AGED 3 YEARS AND OLDER BY SEX, PURPOSE, ZONE, AND REGION"
./pdfETHCSApipeline.sh 2008-Livestock.pdf pages.pdf table3-10.csv 57 58 tmpTable.csv 2008_Table_3-10.csv 2008
...
./pdfETHCSApipeline.sh 2008-Livestock.pdf pages.pdf table3-19d.csv 87 88 tmpTable.csv 2008_Table_3-19d.csv 2008
...
./pdfETHCSApipeline.sh 2008-Livestock.pdf pages.pdf table3-20d.csv 103 104 tmpTable.csv 2008_Table_3-20d.csv 2008
...
./pdfETHCSApipeline.sh 2008-Livestock.pdf pages.pdf table3-27d.csv 143 144 tmpTable.csv 2008_Table_3-27d.csv 2008
echo "2008 Horses tables complete"
