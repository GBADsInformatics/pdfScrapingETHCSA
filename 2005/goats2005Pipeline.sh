#
# Script to create all of the 2005 Goat tables
#
...
./pdfETHCSApipeline.sh 2005-Livestock.pdf pages.pdf table3-4.csv 45 46 tmpTable.csv 2005_Table_3-4.csv 2005
echo "TABLE 3-9: GOATS AGED 2 YEARS AND OLDER BY SEX, PURPOSE, ZONE, AND REGION"
./pdfETHCSApipeline.sh 2005-Livestock.pdf pages.pdf table3-9.csv 55 56 tmpTable.csv 2005_Table_3-9.csv 2005
echo "TABLE 3-16: NUMBER OF GOATS BY SEX, BREED, ZONE, AND REGION"
./pdfETHCSApipeline.sh 2005-Livestock.pdf pages.pdf table3-16.csv 69 70 tmpTable.csv 2005_Table_3-16.csv 2005
...
./pdfETHCSApipeline.sh 2005-Livestock.pdf pages.pdf table3-19c.csv 85 86 tmpTable.csv 2005_Table_3-19c.csv 2005
...
./pdfETHCSApipeline.sh 2005-Livestock.pdf pages.pdf table3-20c.csv 101 102 tmpTable.csv 2005_Table_3-20c.csv 2005
echo "TABLE 3-23c: ESTIMATED NUMBER OF VACCINATED LIVESTOCK BY ZONE AND REGION - Goats"
./pdfETHCSApipeline.sh 2005-Livestock.pdf pages.pdf table3-23c.csv 125 126 tmpTable.csv 2005_Table_3-23c.csv 2005
...
./pdfETHCSApipeline.sh 2005-Livestock.pdf pages.pdf table3-27c.csv 145 146 tmpTable.csv 2005_Table_3-27c.csv 2005
echo "2005 Goats tables complete"
