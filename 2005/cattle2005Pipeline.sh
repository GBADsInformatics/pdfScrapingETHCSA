#
# Script to create all of the 2005 Cattle tables
#
...
./pdfETHCSApipeline.sh 2005-Livestock.pdf pages.pdf table3-2.csv 41 42 tmpTable.csv 2005_Table_3-2.csv 2005
echo "TABLE 3-7: CATTLE AGED 3 – 10 YEARS BY SEX, PURPOSE, ZONE, AND REGION"
./pdfETHCSApipeline.sh 2005-Livestock.pdf pages.pdf table3-7.csv 51 52 tmpTable.csv 2005_Table_3-7.csv 2005
echo "TABLE 3-14: NUMBER OF CATTLE BY SEX, BREED, ZONE, AND REGION"
./pdfETHCSApipeline.sh 2005-Livestock.pdf pages.pdf table3-14.csv 65 66 tmpTable.csv 2005_Table_3-14.csv 2005
...
./pdfETHCSApipeline.sh 2005-Livestock.pdf pages.pdf table3-19a.csv 69 70 tmpTable.csv 2005_Table_3-19a.csv 2005
...
./pdfETHCSApipeline.sh 2005-Livestock.pdf pages.pdf table3-27a.csv 141 142 tmpTable.csv 2005_Table_3-27a.csv 2005
echo "2005 Cattle tables complete"
