#
# Script to create all of the 2020 Sheep tables
#
...
./pdfETHCSApipeline.sh 2020-Livestock.pdf pages.pdf table3-3.csv 44 45 tmpTable.csv 2020_Table_3-3.csv 2020
echo "TABLE 3-8: SHEEP AGED 2 YEARS AND OLDER BY SEX, PURPOSE, ZONE, AND REGION"
./pdfETHCSApipeline.sh 2020-Livestock.pdf pages.pdf table3-8.csv 54 55 tmpTable.csv 2020_Table_3-8.csv 2020
echo "TABLE 3-15 NUMBERS OF SHEEP BY SEX, BREED, ZONE, AND REGION"
./pdfETHCSApipeline.sh 2020-Livestock.pdf pages.pdf table3-15.csv 68 69 tmpTable.csv 2020_Table_3-15.csv 2020
...
./pdfETHCSApipeline.sh 2020-Livestock.pdf pages.pdf table3-19b.csv 85 86 tmpTable.csv 2020_Table_3-19b.csv 2020
...
./pdfETHCSApipeline.sh 2020-Livestock.pdf pages.pdf table3-20b.csv 101 102 tmpTable.csv 2020_Table_3-20b.csv 2020
echo "TABLE 3-23b: ESTIMATED NUMBER OF VACCINATED LIVESTOCK BY ZONE AND REGION - Sheep"
./pdfETHCSApipeline.sh 2020-Livestock.pdf pages.pdf table3-23b.csv 125 126 tmpTable.csv 2020_Table_3-23b.csv 2020
...
./pdfETHCSApipeline.sh 2020-Livestock.pdf pages.pdf table3-27b.csv 141 142 tmpTable.csv 2020_Table_3-27b.csv 2020
echo "2020 Sheep tables complete"
